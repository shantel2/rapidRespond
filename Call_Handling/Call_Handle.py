...
def handle_gather():
    ...
    if user_response == "1":
        ...
        #Handles the case where only one location is detected (ideal).
        if len(GlobalLocation) == 1 and GlobalLocation[0] != None:
            gather = Gather(num_digits=1, action="/handle_location_confirmation", method="POST")
        ...
        #Handles the case where more than one location is detected.   
        ...
        #Handles the case where no location is detected.
        ...
        #User press an incorrect choice on their keypad and is given the chance to correct it.
        ...
        #User press an incorrect choice on their keypad and is not given the chance to correct it.
